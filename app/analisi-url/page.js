              ...
              <div className={styles["analysis-results"]}>
                <div className={styles["analysis-results-grid"]}>
                  <div className={styles["lighthouse-card"]}>
                    ...
                    <p>
                      Indica la velocità di caricamento del sito e
                  ...
                  <div className={styles["lighthouse-card"]}>
                    ...
                    <p>
                      Rappresenta l&apos;adesione agli standard di sviluppo web
                      e sicurezza.
                    </p>
                  </div>
                  <div className={styles["lighthouse-card"]}>
                  ...
                  {avgScore >= 90 ? (
                    <div className={styles["avg-score"]}>
                      ...
                      <p className={styles["avg-score-description"]}>
                        Gli utenti ottengono un&apos;esperienza ottimale, il
                        sito web è ben ottimizzato per le prestazioni,
                        accessibile a un&apos;ampia gamma di utenti, sicuro e
                        rilevabile dai motori di ricerca.
                      </p>
                    </div>
                  ) : avgScore >= 70 ? (
                    <div className={styles["avg-score"]}>
                    ...
                    <div className={styles["avg-score"]}>
                      ...
                      <p className={styles["avg-score-description"]}>
                        Il sito web è probabilmente lento, difficile da
                        utilizzare per alcuni tipi di pubblico e manca di
                        importanti best practices per la sicurezza e/o
                        l&apos;accessibilità, richiedendo una strategia di
                        ottimizzazione più completa.
                      </p>
                    </div>
                  )}
                </div>
                {avgScore >= 70 && avgScore < 90 && (
                  ...
                  >
                    <p>
                      ...
                      risultati non sono male, ma sai che potresti ottenere
                      ancora di più? 😊
                    </p>
                    <p>
                      Prenota una <strong>consulenza gratuita</strong> con il
                      nostro team e ti mostreremo come possiamo aiutarti a
                      sviluppare un sito web che sia davvero il top in termini
                      di velocità, usabilità e visibilità. Non accontentarti di
                      buoni risultati, punta all&apos;eccellenza! 💪
                    </p>
                    <Link href="/contatti">
                ...
                {avgScore < 70 && (
                  ...
                  >
                    <p>
                      L&apos;analisi del tuo sito web ha rilevato alcuni
                      problemi importanti: con un punteggio sotto i 70, il sito
                      non sta performando come dovrebbe. Ma non preoccuparti,
                      siamo qui per aiutarti! 😉
                    </p>
                    <p>
                      <strong>
                        Non lasciare che un sito lento o inefficiente danneggi
                        la tua immagine online!
                      </strong>{" "}
                      Prenota una consulenza gratuita e insieme valuteremo come
                      migliorare drasticamente le prestazioni andando a
                      sviluppare un sito web che si carica in un batter
                      d&apos;occhio, perfettamente ottimizzato per i motori di
                      ricerca e che offra un&apos;esperienza fluida e
