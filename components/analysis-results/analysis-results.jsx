...
import styles from "../../app/analisi-url/analysis.module.css";
      ...
      <div className={styles["analysis-content"]}>
          ...
          <div className={styles["analysis-results"]}>
            <div className={styles["analysis-results-grid"]}>
              ...
              <div className={styles["lighthouse-card"]}>
                ...
                <p className={cssBestPracticesClasses}>{bestPracticesScore}</p>
                <p>
              ...
              <div className={styles["lighthouse-card"]}>
                <h3>Accessibilità</h3>
                <p className={cssAccessibilityClasses}>{accessibilityScore}</p>
                <p>
                  Valuta quanto il sito sia facilmente utilizzabile da tutti gli
              ...
              {avgScore >= 90 ? (
                <div className={styles["avg-score"]}>
                  ...
                  <p className={styles["avg-score-description"]}>
                    Gli utenti ottengono un&apos;esperienza ottimale, il sito
                    web è ben ottimizzato per le prestazioni, accessibile a
                    un&apos;ampia gamma di utenti, sicuro e rilevabile dai
                    motori di ricerca.
                  </p>
                </div>
              ) : avgScore >= 70 ? (
                ...
                <div className={styles["avg-score"]}>
                  ...
                  <p className={styles["avg-score-description"]}>
                    Il sito web è probabilmente lento, difficile da utilizzare
                    per alcuni tipi di pubblico e manca di importanti best
                    practices per la sicurezza e/o l&apos;accessibilità,
                    richiedendo una strategia di ottimizzazione più completa.
                  </p>
                </div>
              )}
            </div>
            {avgScore >= 70 && avgScore < 90 && (
              <div className={`${styles["analysis-cta"]} ${styles["warning"]}`}>
                <p>
                ...
                <p>
                  Prenota una <strong>consulenza gratuita</strong> con il nostro
                  team e ti mostreremo come possiamo aiutarti a sviluppare un
                  sito web che sia davvero il top in termini di velocità,
                  usabilità e visibilità. Non accontentarti di buoni risultati,
            ...
            {avgScore < 70 && (
              <div className={`${styles["analysis-cta"]} ${styles["danger"]}`}>
                ...
                <p>
                  ...
                  perfettamente ottimizzato per i motori di ricerca e che offra
                  un&apos;esperienza fluida e accessibile a tutti i tuoi utenti.
                  💪
                </p>
                <Link href="/contatti">Richiedi una consulenza gratuita</Link>
              </div>
        ...
        {error && (
          <p className="error-message">
            {error} <br></br> Indirizzo URL non trovato.
          </p>
        )}
      </div>
    </section>
